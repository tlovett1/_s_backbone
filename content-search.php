...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-footer">
		...
		<span class="comments-link"><?php comments_popup_link( esc_html__( 'Leave a comment', '_s_backbone' ), esc_html__( '1 Comment', '_s_backbone' ), esc_html__( '% Comments', '_s_backbone' ) ); ?></span>
		<?php endif; ?>
